      ...
      <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-sky-700">
            iBold AI Proxy Platform
          </p>
          <h1 className="text-xl font-semibold text-slate-900 sm:text-2xl">Realtime Quota Dashboard</h1>
          <p className="mt-0.5 text-xs text-slate-500">
            Live usage, limits, and generation control in one workspace.
          </p>
        </div>
